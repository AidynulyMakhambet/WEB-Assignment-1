...
4. **Part 4: Intermediate CSS (Steps 15–21)**
   ...
   - Segmented layout sections using semantic block container `<div>` tags (`header-section`, `main-container`, `footer-section`)[cite: 1].
...
![HTML Basics](WEB Assignment 1\Screenshots\image.png)
